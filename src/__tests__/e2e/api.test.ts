...
import app from '../../app';
import { createTestUser, createTestCompanyUser, createTestToken } from '../helpers/testHelpers';
...
describe('E2E API Tests', () => {
  describe('Complete User Flow', () => {
    it('should complete full user registration and login flow', async () => {
      ...
      expect(sessionResponse.body.data.user.email).toBe('e2e@example.com');
    });
    ...
    it('should complete company message flow', async () => {
      ...
      expect(getMessageResponse.body.success).toBe(true);
      expect(getMessageResponse.body.data.content).toBe('E2E test message');
