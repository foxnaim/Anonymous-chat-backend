...
export const createMessageSchema = z.object({
  body: z.object({
    companyCode: z.string().length(8, 'Company code must be exactly 8 characters'),
...
export const getMessagesSchema = z.object({
  query: z.object({
    companyCode: z.string().length(8, 'Company code must be exactly 8 characters').optional(),
  }),
});
